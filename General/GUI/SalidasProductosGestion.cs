...
{
    public partial class SalidasProductosGestion : Form
    {
        ...
        private void CargarDatos()
        {
            try
            {
                datos.DataSource = DataManager.DBConsultas.SalidasProductos();
        ...
        public SalidasProductosGestion()
        {
            InitializeComponent();
        }

        private void GestionSalidasProductos_Load(object sender, EventArgs e)
        {
            CargarDatos();
